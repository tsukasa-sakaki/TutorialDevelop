...
class UserControllerTest {
    ...
    void testgetList() throws Exception {
        ...
        Integer user1Id = userlist.get(0).getId();
        Integer user2Id = userlist.get(1).getId();
        Integer user3Id = userlist.get(2).getId();
        assertEquals(user1Id, 1);
        assertEquals(user2Id, 2);
        assertEquals(user3Id, 3);
        String user1Name = userlist.get(0).getName();
        String user2Name = userlist.get(1).getName();
        String user3Name = userlist.get(2).getName();
        assertEquals(user1Name, "キラメキ太郎");
        assertEquals(user2Name, "キラメキ次郎");
        assertEquals(user3Name, "キラメキ花子");
